...
public class MenuManager : MonoBehaviour {
    ...
    //Agrega todas las instancias de menu que deseas aqui. 
    ...
    public void OpenMenu(Menu menuInstance){
        ...
        if(menuInstance == null){
            Debug.LogWarning("MENU MANAGER: MENU INVALIDO");
    ...
    public void CloseMenu(){
        if(_menuStack.Count==0){
            Debug.LogWarning("MENU MANAGER : YA NO HAY MENUS EN EL STACK");
            return;
        }
